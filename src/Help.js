...
function Help() {
  ...
  const faqData = [
    ...
    { question: "How can I contact Supply2U for inquiries?", answer: "For support or inquiries, you can reach out to Supply2U by visiting our contact page. We provide several communication options, including email and phone support to assist you with any questions or concerns." },
  ];
